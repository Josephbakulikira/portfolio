      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul className="socialContainer">
            ...
            <li className="w-[130px] h-[40px] flex justify-between items-center ml-[-80px] hover:ml-[-10px] duration-300 bg-[#ff0000]">
                <a className="flex justify-between items-center w-full text-gray-300" href="/" target='blank'>youtube<FaYoutube size="25" /></a>
            </li>
            <li className="w-[130px] h-[40px] flex justify-between items-center ml-[-80px] hover:ml-[-10px] duration-300 bg-[#11a2fa]">
                <a className="flex justify-between items-center w-full text-gray-300" href="mailto:bakulikiraj@gmail.com" target='blank'>Mail<HiOutlineMail size="25" /></a>
            </li>
            <li className="w-[130px] h-[40px] flex justify-between items-center ml-[-80px] hover:ml-[-10px] duration-300 bg-[#888888]">
                <a className="flex justify-between items-center w-full text-gray-300" href="../../assets/JosephBakulikira.pdf" target='blank' download>Resume<BsFillPersonLinesFill size="25" /></a>
            </li>
        </ul>
      </div>
